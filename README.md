...
* 타이머는 1초(운영변수)마다 반복하고 1초(운영변수) 후에도 아직 삭제를 하는 중이면 삭제를 요구하지 않고 지나갑니다.

* 타이머는 REST서버를 통해 /period/5 와 같이 호출하여 1초에서 5초로 변경을 할 수 있습니다. 그리고 타이머를 반복하는 주기를 변경하였다면 /restart를 호출하여 다시 시작할 수 있습니다.
